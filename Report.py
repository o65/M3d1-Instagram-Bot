...
            your_user_id = str(user_id.split("_")[1])# 35117478443
            urlRep = "https://i.instagram.com/mirela.shpati/" + your_user_id + "/report/" 
            datas = {  
                    'source_name': '', 'reason_id': 2, 'frx_context': ''  # self injury
                } 
            req_SessionID = r.post(urlRep, data=datas) 
            done += 1 
            print(f"Done self injury  by @medishala1 : : {done}") 
            time.sleep(0.1) 
    else: 
